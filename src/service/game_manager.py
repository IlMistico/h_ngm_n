...
class SinglePlayerGameManager:
    ...
    # Streamlit-only functions

    def get_difficulty_map(self):
        return self.difficulty_map

    def check_player_exists(self, username):
        return username in self.games.keys()
...
class MultiplayerGameManager:
    def __init__(self) -> None:
        ...
        self.players_map: Dict[str, str] = {}
        self.games: Dict[str, Game] = {}

    def start_game(self, players: List[str], difficulty: str):
        if difficulty not in self.difficulty_map.keys():
            raise KeyError(f"Difficulty {difficulty} unknown.")
        ...
        for player in players:
            ...
            self.players_map[player_id] = player
